...
import { SearchGaragesDocument } from '@safari/network/src/gql/generated'
import { useEffect } from 'react'
import { GarageMarker } from './GarageMarker'
import { useConvertSearchFormToVariables } from '@safari/forms/src/adapters/searchFormAdapter'
